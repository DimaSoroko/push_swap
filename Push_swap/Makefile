...
NAME			= push_swap                 											# name of the program
...
SRCS			= 	srcs/check_input.c\
					srcs/lists_operations.c\
					srcs/push_swap.c\
					srcs/rotate.c\
					srcs/shift_and_rotate.c\
					srcs/small_sorting.c\
					srcs/sorting.c\
					srcs/stack_utils.c\
					srcs/swap.c
...
$(NAME):	$(OBJS)
			...
			@echo $(BGreen)√$(Color_Off)$(BBlue)Push_Swap Has Been Compiled!$(Color_Off);
			@echo $(BBlue)To Use Push_Swap :$(BGreen)$(UGreen)./push_swap ...Random Numbers...$(Color_Off);
